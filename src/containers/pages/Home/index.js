        ...
        return(
            ...
            <View style={styles.layout}>
                ...
                <View style={styles.container}>
                    ...
                    <MenuIcon menuTitle={styles.menuTitle} style={styles.menuKiri} studyGuide={() => this.props.navigation.navigate('StudyGuide')}  title="STUDY GUIDE" img={require('../../../assets/icon/studyguide.png')} />
                    ...
                    <SampleAddsBanner onPress={() => alert('Hello Wahyu')}/>
                ...
                <View style={styles.navBar}>
									<TouchableOpacity style={styles.navBarMenuKiri}>
										<View style={{width:43, height:43, alignItems: "center", justifyContent: "center"}}>
											<Image source={require('../../../assets/icon/home_active.png')} style={{width: 30, height: 30}} />
										</View>
									</TouchableOpacity>
									...
									<TouchableOpacity onPress={() => this.props.navigation.navigate('Message')} style={styles.navBarMenu}>
										<View style={{width:43, height:43, alignItems: "center", justifyContent: "center"}}>
